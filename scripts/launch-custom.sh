...
case "$choice" in
  ...
  2) bash scripts/switch.sh --force beellama/gemma-e4b-dual-q4_0 ;;
  3) bash scripts/switch.sh --force vllm/gemma-e4b-dual-bf16 ;;
  4) bash scripts/switch.sh vllm/dual ;;
  5) bash scripts/switch.sh vllm/gemma-31b-dual ;;
